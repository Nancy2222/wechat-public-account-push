export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxc0c2a87f6f7c529e",

  // 公众号APP_SECRET
  APP_SECRET: "fbb781d2c26554d8e1f3abcec9530860",
   ...
   *    // 你想对他发送的模板消息的模板ID
   *    useTemplateId: "tvgRSonznsAJw0DCStxPboSDuvcNrtccFiFdIkWeqsI",
  ...
  USERS: [
    {
      ...
      id: "oIMKK5okxWGTDw4Uh_YEn1EHKPgg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "EX4LDTIxbjEjAjC2hlpY33k5UBMae-CyBItudnpvIQA",
      // 所在省份
      province: "吉林",
      // 所在城市
      city: "长春",
  ...
  CUSTOMIZED_DATE_LIST: [
    // 在一起的日子
    {"keyword": "love_day", date: "2020-08-30"},
    // sakana日
